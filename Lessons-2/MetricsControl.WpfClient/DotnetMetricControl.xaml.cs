...
namespace MetricsControl.WpfClient
{
    ...
    /// </summary>
    public partial class DotnetMetricControl : UserControl, INotifyPropertyChanged
    {
        ...
        private async void UpdateOnСlick(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                AllDotnetMetricsApiResponse response = await _metricsControlClient.GetAllById2Async(
                    1,
