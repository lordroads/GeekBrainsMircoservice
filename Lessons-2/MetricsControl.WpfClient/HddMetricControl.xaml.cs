...
namespace MetricsControl.WpfClient
{
    ...
    /// </summary>
    public partial class HddMetricControl : UserControl, INotifyPropertyChanged
    {
        ...
        private async void UpdateOnСlick(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                AllHddMetricsApiResponse response = await _metricsControlClient.GetAllById3Async(
                    1,
                ...
                ColumnSeriesValues = new SeriesCollection
                {
                     new LineSeries
                    {
                        Fill = new SolidColorBrush(Color.FromArgb(125, 255, 200, 0)),
